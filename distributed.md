...
![Distributed Minio, 8 nodes with 1 disk each](https://github.com/deekoder/doctest/blob/master/Distributed8.png?raw=true)
...
![Distributed Minio, 4 nodes with 4 disks each](https://github.com/deekoder/doctest/blob/master/Distributed16.png?raw=true)
